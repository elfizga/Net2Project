            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category"> المساحة المستخدمة</p>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title"> نشر الوظائف </h4>
                  <p class="card-category">
                    <span class="text-success"> زيادة بنسبة <i class="fa fa-long-arrow-up"></i> 55% </span>  </p>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i> تم التحديث منذ 4 أيام 
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category"> احصائيات انضمام المستخدمين للنظام </p>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i> تم التحديث منذ اسبوع
                  </div>
                </div>
              </div>
            </div>
