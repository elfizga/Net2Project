<?php
   ...
   ?>
            <div class="page animated" style="opacity: 1;">
                <?php include 'include/header.php';?>
                    <section class="section breadcrumbs-custom breadcrumbs-custom-overlay-2">
                        <div class="breadcrumbs-custom-main bg-image bg-gray-700" style="background-image: url(images/bg-image-8.jpg);">
                            <div class="container">
                                <h2 class="breadcrumbs-custom-title"> التسجيل كزبون </h2>
                            </div>
                        </div>
                    </section>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-wrap ">
                                                    ...
                                                    <div class="form-group">
                                                        <select class="form-control form-control-has-validation" id="rd-navbar-register-address" data-placeholder="اختر الصنف " name="location" data-constraints="@Selected">
